using ExternalService.API.Events;
using Rabbitmq.Core;
...
app.MapGet("/weatherforecast", () =>
    ...
    .WithOpenApi();
app.MapPost("/add-order",async (CreateOrderCommand command,IEventBus eventBus) =>
{
    var @event = new ExternalEventOrderCreatedEvent(Guid.NewGuid(),command.CustomerName);
